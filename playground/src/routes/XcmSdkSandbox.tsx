...
const XcmSdkSandbox = () => {
  ...
  return (
    <Tabs defaultValue="xcm-transfer">
      <Tabs.List>
        <Tabs.Tab value="xcm-transfer" leftSection={<IconSend2 style={iconStyle} />}>
          XCM Transfer
        </Tabs.Tab>
        <Tabs.Tab value="assets" leftSection={<IconCoins style={iconStyle} />}>
          Assets
        </Tabs.Tab>
        <Tabs.Tab value="pallets" leftSection={<IconBoxAlignBottomRight style={iconStyle} />}>
          Pallets
        </Tabs.Tab>
        <Tabs.Tab value="hrmp-channels" leftSection={<IconArrowsUpDown style={iconStyle} />}>
          HRMP Channels
        </Tabs.Tab>
      </Tabs.List>
